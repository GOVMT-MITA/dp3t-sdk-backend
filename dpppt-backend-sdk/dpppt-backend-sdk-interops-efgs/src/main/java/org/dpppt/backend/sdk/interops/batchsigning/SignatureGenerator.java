...
package org.dpppt.backend.sdk.interops.batchsigning;
...
public class SignatureGenerator {
  ...
  public String sign(final byte[] data) throws CertificateEncodingException,
    OperatorCreationException, CMSException, IOException {
    return sign(data, certificate, true, true);
  }
